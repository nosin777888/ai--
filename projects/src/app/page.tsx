  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] flex flex-col items-center px-4 py-8">
      ...
      <header className="text-center mb-8">
        <h1
          className="text-4xl md:text-5xl text-purple-600 mb-3"
      ...
      <div className="w-full max-w-xl mb-10">
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-7 py-3 rounded-xl bg-[#E8845C] text-white text-lg font-medium
                       hover:bg-[#D4734A] active:scale-95
